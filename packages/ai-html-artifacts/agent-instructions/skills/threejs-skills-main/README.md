...
| **threejs-games**          | Full playable single-file games: loop, state machine, input, HUD, collision, pooling, audio |
...
These skills have been audited against the official Three.js documentation (r169) for:
